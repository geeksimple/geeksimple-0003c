              ...
              <div className="container container--md">
                ...
                <header className="post__header">
                  ...
                  <div className="post__meta">
                    <span>🕘 <time dateTime={moment(_.get(this.props, 'pageContext.frontmatter.date', null)).strftime('%Y-%m-%d %H:%M')}>{moment(_.get(this.props, 'pageContext.frontmatter.date', null)).strftime('%d.%m.%Y')}</time></span>

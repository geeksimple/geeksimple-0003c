...
+ um beim nächsten Familienessen so richtig anzugeben
 oder wenn Ihr bisher die meiste Zeit nur Bahnhof verstanden habt, gibt es diesen Blog. Hier werden (mittlerweile) alltägliche Begriffe wie Algorithmus, WLan, Datenbank usw. ganz einfach und anschaulich erklärt.
